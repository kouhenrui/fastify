...
import { closeAllDataSources, initializeAllDataSources, mongoDataSource, postgresDataSource, typeormHealthCheck } from "../../config/orm/typeorm";
...
const typeormPlugin: FastifyPluginAsync<TypeormOptions> = async (fastify, options = {}) => {
