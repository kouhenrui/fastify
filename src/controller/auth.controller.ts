...
class AuthController {
  ...
  login = async (
    ...
    try {
      ...
      return reply.success(
        result,
        t("auth.login.success", undefined, request.lang)
      );
    } catch (error: any) {
  ...
  register = async (
    ...
    try {
      ...
      return reply.success(
        result,
        t("auth.register.success", undefined, request.lang)
      );
    } catch (error: any) {
  ...
  getUserList = async (request: FastifyRequest, reply: FastifyReply) => {
    try {
      ...
      return reply.success(
        result,
        t("auth.user.list.success", undefined, request.lang)
      );
    } catch (error: any) {
      throw ErrorFactory.business(error.message, error.code, error.details);
    }
  ...
  getRoleList = async (request: FastifyRequest, reply: FastifyReply) => {
    ...
    return reply.success(
      result,
      t("auth.role.list.success", undefined, request.lang)
    );
  };
  getRole = async (
    ...
    return reply.success(
      result,
      t("auth.role.get.success", undefined, request.lang)
    );
  };
